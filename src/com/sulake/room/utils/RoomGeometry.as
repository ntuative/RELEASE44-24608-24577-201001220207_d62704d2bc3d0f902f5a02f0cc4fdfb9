package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_2300:Number = 500;
      ...
      private var var_2299:Number = -500;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_226.assign(param1);
         if(var_226.x != _loc2_ || var_226.y != _loc3_ || var_226.z != _loc4_)
         {
            ++var_87;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            _y.assign(_loc24_);
            var_95.assign(_loc25_);
         }
         else
         {
            var_94.assign(_loc18_);
            _y.assign(_loc19_);
            var_95.assign(_loc20_);
         }
      }
      
      public function set z_scale(param1:Number) : void
      {
         if(var_391 != param1 * var_1451)
         {
            var_391 = param1 * var_1451;
            ++var_87;
         }
      }
      ...
      {
         if(var_389 != param1 * var_1450)
         {
            var_389 = param1 * var_1450;
            ++var_87;
         }
      }
      ...
      {
         if(var_392 != param1 * var_1449)
         {
            var_392 = param1 * var_1449;
            ++var_87;
         }
      }
      ...
      {
         return new Vector3d(var_226.x,var_226.y,var_226.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_983.assign(_loc22_);
         }
         else
         {
            var_983.assign(_loc17_);
         }
         ++var_87;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_392;
         _loc2_.z *= var_391;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_983);
         if(_loc3_ < var_2299 || _loc3_ > var_2300)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_392;
            _loc2_.z *= var_391;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_983);
         }
      ...
      {
         return new Vector3d(0 * var_389,0 * var_392,0 * var_391);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,var_95);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function get directionAxis() : IVector3d
      {
         return new Vector3d(var_95.x,var_95.y,var_95.z);
      }
      ...
      {
         if(param1 == null || var_95 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(var_95,param2);
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_200;
         var _loc6_:Number = -param1.y / var_200;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_94,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_389,0 * var_392,0 * var_391);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_95;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_389,param2.y * var_392,param2.z * var_391);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_389,param3.y * var_392,param3.z * var_391);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_389,param4.y * var_392,param4.z * var_391);
