package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1025:uint = 1;
      ...
      private var var_1090:ProfilerAgentTask;
      
      private var var_1088:IEventDispatcher;
      
      private var var_2312:uint = 0;
      
      private var var_1091:ProfilerAgentTask;
      
      private var var_1089:ProfilerOutput;
      
      private var var_611:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_204 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1088 = Component(param1).events;
            var_746 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_611 = new WindowRenderer(_loc4_);
         var_288 = new Array(const_333);
         var _loc6_:int = 0;
         while(_loc6_ < const_333)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_611,this,_localization,var_204,new Rectangle(0,0,var_204.stageWidth,var_204.stageHeight),this);
            var_288[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_383 = var_288[const_1025];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_383.getMouseCursor().defineCustomCursorType(MouseCursorType.const_305,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_383.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1158,_loc7_);
      }
      ...
      {
         return var_288[param1].getDesktopWindow().getChildAt(var_383.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1089 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1089 = new ProfilerOutput(_loc3_,this,var_611);
               var_1090 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1090);
               var_1091 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1091);
               var_911 = true;
            }
         }
      }
      ...
      {
         return var_383.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_884.length > 0)
         {
            var_1088.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_333 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1088.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_884.length > 0)
         {
            WindowContext.var_884.flush();
         }
         if(WindowContext.var_1314.length > 0)
         {
            WindowContext.var_1314.flush();
         }
         var_1088.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_746[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_746[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_383.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1146,param2.name + ": " + param2.toString());
            }
         }
      }
   }
