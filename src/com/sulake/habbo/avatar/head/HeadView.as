package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_126,param2,param3);
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_150,param2,param3);
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_152,param2,param3);
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_142,param2,param3);
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_145,param2,param3);
         attachImages();
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1057);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_684[var_1415];
         if(_loc2_ == null)
         {
            return;
         }
