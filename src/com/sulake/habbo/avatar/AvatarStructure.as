package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_370:PartSetsData;
      
      private var var_1642:PartOffsetData;
      
      private var var_750:AvatarActionManager;
      
      private var var_154:IAssetLibrary;
      
      private var var_2242:IAssetLibrary;
      
      private var var_1330:Boolean = false;
      
      private var var_1643:AvatarRenderManager;
      
      private var var_436:FigureData;
      ...
      private var var_1354:AvatarStructureDownloadSet;
      
      private var var_612:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_154 = param2;
         var_2242 = param3;
         var_436 = new FigureData();
         var_370 = new PartSetsData();
         _animationData = new AnimationData();
         var_1354 = new AvatarStructureDownloadSet();
         var_612 = new AnimationManager();
         var_613 = param4;
         var_1642 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_750.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_613)
         {
            case AvatarType.const_89:
               _loc1_ = var_154.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_370.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_154.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_154.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_436.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_154.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_370.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_154.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_154.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_436.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_750.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_750.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_612.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_370.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_370.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_750.getDefaultActionType();
         var _loc7_:Array = var_370.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_612.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_436.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_436.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_370.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_370.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_89:
               if(var_154.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_154.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_154.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_154.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_613 + " ready to go!");
         if(var_613 == AvatarType.const_89)
         {
            var_370.getPartDefinition("ri").appendToFigure = true;
            var_370.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_89:
               var_1354.add(new AvatarStructureDownload(var_154,_loc5_,var_436));
               break;
            case AvatarType.PET:
         }
         var_1354.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_612.getAnimation(param1);
      }
      ...
      {
         var_750 = new AvatarActionManager(var_154,var_613);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_154.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_154.getAssetByName("dance" + _loc1_).content as XML;
            var_612.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_154.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_154.getAssetByName("fx" + _loc1_).content as XML;
            var_612.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_436.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_436.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_750.sortActions(param1);
      }
   }
}
