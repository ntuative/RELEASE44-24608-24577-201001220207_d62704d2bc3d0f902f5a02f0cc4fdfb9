package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1547:IWindowContainer;
      
      public static var var_1315:IWindowContainer;
      
      public static var var_1057:int = 6710886;
      ...
      private var var_1426:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1315 == null)
         {
            ...
            var_1315 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1547 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1547 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_703 != null)
         {
            toggleCategoryView(var_703,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1426 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function method_3(param1:String) : void
      {
         ...
         var_703 = param1;
         var_1426.setSelected(var_1426.getSelectableByName(param1));
         _window.invalidate();
      }
