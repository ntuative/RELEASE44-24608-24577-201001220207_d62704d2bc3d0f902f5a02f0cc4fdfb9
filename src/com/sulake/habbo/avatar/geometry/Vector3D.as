package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      private var var_952:Number;
      
      private var var_94:Number;
      
      private var _y:Number;
      
      private var var_95:Number;
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_95 * param1.y;
         _loc2_.y = var_95 * param1.x - var_94 * param1.z;
      ...
      {
         return Math.sqrt(var_94 * var_94 + _y * _y + var_95 * var_95);
      }
      ...
      {
         return var_94 * param1.x + _y * param1.y + var_95 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_94 + "," + _y + "," + var_95 + "," + var_952 + ")";
      }
