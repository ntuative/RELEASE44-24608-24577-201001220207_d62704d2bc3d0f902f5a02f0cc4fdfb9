package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_964:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_964.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_965)
         {
            ...
            var_649["null"] = new FigureData(this);
            var_649["null"] = new FigureData(this);
            _loc1_ = var_649["null"];
            _loc2_ = var_649["null"];
            ...
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_80);
            var_338 = new Map();
            var_338.add(AvatarEditorCategory.const_990,new GenericModel(this));
            var_338.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_338.add(AvatarEditorCategory.const_284,new TorsoModel(this));
            var_338.add(AvatarEditorCategory.const_1300,new LegsModel(this));
            var_338.add(AvatarEditorCategory.const_514,new WardrobeModel(this));
            var_965 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_338.getValue(AvatarEditorCategory.const_514);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_338.getValue(AvatarEditorCategory.const_514);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_964.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1547.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1315.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1152)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1315.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      public function method_11(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_383 == null)
            {
               var_383 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_383.addChild(_view.window);
               var_383.center();
               var_383.visible = false;
            }
            var_383.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_990);
         if(var_180 != null)
         {
            urlString = var_180.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1154 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_26 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_629,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_964 = var_1154.getFigureData(AvatarType.const_89);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_966 = param3;
         var _loc4_:FigureData = var_649[param2];
         if(_loc4_ == null)
         {
            return;
         }
