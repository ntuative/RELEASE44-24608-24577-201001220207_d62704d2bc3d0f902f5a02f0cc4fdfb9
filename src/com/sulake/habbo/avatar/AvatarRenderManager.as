package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_667:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_296.getValue(AvatarType.const_89) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_296.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      {
         var _loc5_:String = var_667.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_296.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_296.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_296.getValue(AvatarType.const_89) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_32,param1,param2,AvatarType.const_89);
      }
