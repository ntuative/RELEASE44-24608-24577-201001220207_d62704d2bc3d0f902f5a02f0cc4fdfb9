package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_137,param2,param3);
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_162,param2,param3);
         var_684["null"] = new AvatarEditorGridView(param1,FigureData.const_146,param2,param3);
         attachImages();
