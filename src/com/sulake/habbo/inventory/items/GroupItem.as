package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2231:BitmapData;
      
      protected var var_895:Boolean;
      
      protected var var_2218:Boolean;
      
      protected var var_1876:int;
      ...
      private const const_1410:Number = 0.2;
      
      protected var var_1329:Boolean;
      
      private const const_1409:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_697)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1316);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1329 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2231;
               _loc5_.visible = true;
            }
            else
            {
