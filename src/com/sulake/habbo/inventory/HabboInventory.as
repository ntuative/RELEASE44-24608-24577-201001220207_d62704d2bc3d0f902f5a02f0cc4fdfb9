package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1405:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            var_34.events.removeEventListener(RoomSessionEvent.const_88,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_415,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_415:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_56.getValue(InventoryCategory.const_524));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_56.getValue(InventoryCategory.const_72));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_846));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_56.getValue(InventoryCategory.const_174));
      }
      ...
      {
         return AchievementsModel(var_56.getValue(InventoryCategory.const_328));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_789.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_789.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_56.getValue(InventoryCategory.const_418) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1405 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_56.getValue(InventoryCategory.const_258));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_88,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_415,roomSessionEventHandler);
         ...
         var_56.add(InventoryCategory.const_418,_loc3_);
         ...
         var_56.add(InventoryCategory.const_72,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_589);
         var_56.add(InventoryCategory.const_258,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_56.add(InventoryCategory.const_524,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_589);
         var_56.add(InventoryCategory.const_328,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_56.add(InventorySubCategory.const_264,_loc8_);
         ...
         var_56.add(InventoryCategory.const_174,_loc10_);
