package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function method_3(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1294);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_703 == InventoryCategory.const_174)
            {
               toggleCategoryView(InventoryCategory.const_174);
            }
            else if(var_703 == InventoryCategory.const_72)
            {
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_208 != null && var_868)
            {
               var_208.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_208 != null)
         {
            var_208.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_208 != null)
         {
            var_208.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_646,HabboToolbarIconEnum.INVENTORY,var_28 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_208 != null && var_868)
         {
            var_208.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_868 = false;
         }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_703 || !_controller.isInventoryCategoryInit(param1))
            {
               method_3(param1);
            }
            if(var_208 != null && var_868)
