package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         ...
         var_39.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
      }
      ...
      private function onPetRemoved(param1:PetRemovedFromInventoryEvent) : void
      {
         ...
         var _loc3_:PetsModel = var_26.petsModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FurniModel = var_26.furniModel;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_26.setInventoryCategoryInit(InventoryCategory.const_72,false);
      }
      ...
      {
         var _loc2_:EffectsModel = var_26.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_26.notifyChangedEffects();
      }
      
      private function onTradingAccepted(param1:IMessageEvent) : void
      {
         var _loc2_:TradingModel = var_26.tradingModel;
         if(_loc2_ != null)
         {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_26.setInventoryCategoryInit(InventoryCategory.const_524);
         _loc2_.refreshViews();
         var_26.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = var_26.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         var _loc12_:TradingModel = var_26.tradingModel;
         if(_loc12_ != null)
         {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            var_26.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember);
            var_26.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      private function onMarketplaceItemStats(param1:MarketplaceItemStatsEvent) : void
      {
         ...
         var _loc3_:MarketplaceModel = var_26.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = var_26.badgesModel;
         if(_loc3_ != null)
         {
            _loc3_.updateBadge(_loc2_.badgeID,false);
            _loc3_.removeBadge(_loc2_.removedBadgeID);
         }
         var _loc4_:AchievementsModel = var_26.achievementsModel;
         if(_loc4_ != null)
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_26.setInventoryCategoryInit(InventoryCategory.const_174);
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != var_26.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = var_26.badgesModel;
      ...
      {
         var_26.creditBalance = (param1 as CreditBalanceEvent).getParser().balance;
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_26.setInventoryCategoryInit(InventoryCategory.const_328);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_26.setInventoryCategoryInit(InventoryCategory.const_72);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = var_26.sessionData;
         var _loc3_:IRoomSession = var_26.roomSession;
         if(_loc3_ == null)
         {
            return;
         }
         var_26.toggleInventorySubPage(InventorySubCategory.const_264);
         ...
         var _loc11_:TradingModel = var_26.tradingModel;
         if(_loc11_ != null)
         {
      ...
      {
         var _loc2_:PetsModel = var_26.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_26.setInventoryCategoryInit(InventoryCategory.const_258);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_26.setInventoryCategoryInit(InventoryCategory.const_418);
         var _loc4_:FurniModel = var_26.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
      ...
      {
         var_26.pixelBalance = (param1 as HabboActivityPointNotificationMessageEvent).amount;
      }
