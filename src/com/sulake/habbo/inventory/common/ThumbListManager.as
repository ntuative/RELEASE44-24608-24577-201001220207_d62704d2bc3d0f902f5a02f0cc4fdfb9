package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1009:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_102 = var_567.height;
         var_1010 = param5;
         var_840 = param6;
         var_234 = Math.floor(var_1010 / _thumbWidth);
         var_33 = new BitmapData(var_1010,var_840);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_490 - 1)
         {
            ...
            var_33.fillRect(new Rectangle(0,0 - var_102,var_33.width,var_102),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_33.width,0 - var_102);
               _loc2_ = new Rectangle(0,0,var_33.width,0 - var_102);
               _loc11_.copyPixels(var_33,_loc2_,new Point(0,0),null,null,true);
               var_33 = _loc11_;
               --var_490;
            }
         }
         if(var_33.height < var_840)
         {
            _loc12_ = new BitmapData(var_33.width,var_840);
      ...
      private function getList() : Array
      {
         ...
         if(var_1009 != null)
         {
            _loc1_ = var_1009.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_490 = resolveRowCountFromList();
         if(var_490 == 0)
         {
            var_33 = new BitmapData(var_1010,var_840);
            return;
         }
         var_33 = new BitmapData(Math.max(var_234 * _thumbWidth,var_1010),Math.max(var_490 * var_102,var_840),true,16777215);
         var_33.fillRect(var_33.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_490)
         {
            _loc4_ = 0;
            while(_loc4_ < var_234)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_33.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_102),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_234 && var_33.height < _loc3_.y * var_102)
         {
            _loc2_ = new BitmapData(var_33.width,var_33.height + var_102);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_234 - 1),var_102);
         _loc2_.copyPixels(var_33,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_234 - 1),0,_thumbWidth,var_33.height);
         _loc2_.copyPixels(var_33,_loc4_,new Point(0,var_102),null,null,true);
         _loc4_ = new Rectangle(0,var_102,_thumbWidth * (var_234 - 1),0 - var_102);
         _loc2_.copyPixels(var_33,_loc4_,new Point(_thumbWidth,var_102),null,null,true);
         var_33 = _loc2_;
      }
