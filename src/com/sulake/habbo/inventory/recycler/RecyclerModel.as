package com.sulake.habbo.inventory.recycler
{
   ...
   public class RecyclerModel implements IInventoryModel
   {
      ...
      public function startRecycler() : void
      {
         var_46 = STATE_ACTIVE;
         _itemList = new Map();
         var_26.furniModel.showRecyclable(true);
      }
      ...
      public function lockSelectedFurni() : int
      {
         ...
         var _loc1_:IItem = var_26.furniModel.requestSelectedFurniToRecycler();
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function stopRecycler() : void
      {
         var _loc2_:int = 0;
         var_46 = const_1097;
         if(var_26 != null && false)
         {
            var_26.furniModel.showRecyclable(false);
         }
         else
         {
            _itemList = null;
         ...
         while(_loc1_ < _itemList.length)
         {
            ...
            var_26.furniModel.removeLockFrom(_loc2_);
            _loc1_++;
         }
         _itemList = null;
      }
      ...
      public function releaseFurni(param1:int) : Boolean
      {
         ...
         var_26.furniModel.removeLockFrom(param1);
