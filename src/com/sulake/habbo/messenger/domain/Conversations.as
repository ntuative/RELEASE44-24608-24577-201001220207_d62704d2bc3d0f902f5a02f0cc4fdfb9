package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1085:int = 1;
       
      
      private var _closedConversations:Array;
      
      private var var_368:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_548,0,var_368.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_368.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_368.getTabCount());
      ...
      {
         return var_368.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(_startIndex + var_368.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:Message = method_7(param2);
         _loc3_.addMessage(_loc4_);
         var_368.addMsgToView(_loc3_,_loc4_);
      }
      ...
      private function method_7(param1:Boolean) : Message
      {
      ...
      public function setFollowingAllowedAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_.selected)
         {
            var_368.refresh(false);
         }
      }
      
      public function addTestUser() : void
      {
         this.addConversation(var_1085++);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_368.addMsgToView(_loc3_,param1);
