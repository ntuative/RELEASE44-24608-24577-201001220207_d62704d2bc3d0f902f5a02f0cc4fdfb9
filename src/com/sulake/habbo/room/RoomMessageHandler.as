package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_850,_loc3_.status);
         }
      }
      ...
      private function onItemRemove(param1:IMessageEvent) : void
      {
         ...
         var_24.method_6(_loc3_.roomId,_loc3_.roomCategory,_loc3_.itemId);
      }
