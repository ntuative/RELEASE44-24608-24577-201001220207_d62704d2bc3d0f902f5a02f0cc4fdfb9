package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1427:int = 16777216;
      
      public static const const_1526:int = 1;
       
      
      private var var_2302:int = 69069;
      
      private var var_1270:int = 1;
      
      private var var_2301:int = 5;
      
      private var var_1517:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1517 * param2);
      }
      ...
      {
         var _loc1_:int = var_2302 * var_1270 + var_2301;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
