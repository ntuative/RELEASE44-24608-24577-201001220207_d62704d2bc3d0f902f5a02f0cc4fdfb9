package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_705:PlaneVisualization = null;
      ...
      public function createPlaneVisualization(param1:int, param2:int, param3:Number, param4:Number) : PlaneVisualization
      {
         ...
         var_416.add(String(param1),_loc5_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc5_;
      }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_705 = var_416.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_705 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_416 != null)
         {
            ...
            {
               _loc1_ = var_416.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
