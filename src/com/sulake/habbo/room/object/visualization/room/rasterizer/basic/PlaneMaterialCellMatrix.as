package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1184:int = const_294;
      ...
      public static const const_260:int = const_102;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1338 == const_102)
         {
            _loc5_ = new Rectangle(0,0,var_40.width,var_433);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_433,var_40.width,var_433);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_40 != null)
            {
               if(var_40.width == param2 && var_40.height == param3 && Vector3d.isEqual(var_730,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_433,param6,param7);
                     return param1;
                  }
                  return var_40;
               }
