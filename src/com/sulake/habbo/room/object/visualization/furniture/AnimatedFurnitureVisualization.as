   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.isLastFrame && _loc5_.method_2 <= 1)
               {
                  _lastFramePlayed[_loc4_] = true;
               }
            }
            if(_loc5_ == null || _loc5_.method_2 >= 0 && _loc7_ <= 0)
            {
               _loc6_ = 0;
               if(_loc5_ != null)
               {
               ...
               if(_loc6_ == AnimationFrame.const_778)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1193,var_475,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1193,_loc6_,_loc5_.activeSequenceOffset + 1,var_475,param1);
               }
