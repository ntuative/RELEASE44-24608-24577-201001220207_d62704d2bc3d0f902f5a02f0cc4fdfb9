package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      private static const const_750:Number = 1.5;
         ...
         if(object != null)
         {
            ...
            if(object.getType() == RoomObjectVisualizationEnum.const_129 || object.getType() == RoomObjectVisualizationEnum.BOT)
            {
               ...
               if(param1 is RoomObjectAvatarWaveUpdateMessage)
               {
                  ...
                  if(_loc6_.isWaving)
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_292,new Date().valueOf());
                  }
                  else
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_292,-1);
                  }
               }
               if(param1 is RoomObjectAvatarTypingUpdateMessage)
               {
                  _loc7_ = param1 as RoomObjectAvatarTypingUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_919,Number(_loc7_.isTyping));
               }
               ...
               if(param1 is RoomObjectAvatarDanceUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_867,_loc11_.danceStyle);
               }
               ...
               if(param1 is RoomObjectAvatarEffectUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_979,_loc13_.effect);
               }
               if(param1 is RoomObjectAvatarCarryObjectUpdateMessage)
               {
                  _loc14_ = param1 as RoomObjectAvatarCarryObjectUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_717,_loc14_.itemType);
                  if(_loc14_.itemType > 0)
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_721,new Date().valueOf());
                  }
                  else
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_721,-1);
                  }
               }
               if(param1 is RoomObjectAvatarUseObjectUpdateMessage)
               {
                  _loc15_ = param1 as RoomObjectAvatarUseObjectUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_785,_loc15_.itemType);
               }
               if(param1 is RoomObjectAvatarGestureUpdateMessage)
               {
                  _loc16_ = param1 as RoomObjectAvatarGestureUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_449,_loc16_.gesture);
               ...
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_659,_loc17_.numberOfWords);
                  _loc4_.setNumber(RoomObjectVariableEnum.const_645,new Date().valueOf());
               }
               if(param1 is RoomObjectAvatarSignUpdateMessage)
               {
                  _loc18_ = param1 as RoomObjectAvatarSignUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_881,_loc18_.signType);
               ...
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  ...
                  _loc4_.setString(RoomObjectVariableEnum.const_699,_loc19_.parameter);
               }
               if(param1 is RoomObjectAvatarFlatControlUpdateMessage)
               {
                  _loc20_ = param1 as RoomObjectAvatarFlatControlUpdateMessage;
                  _loc4_.setString(RoomObjectVariableEnum.const_647,_loc20_.rawData);
                  _loc4_.setNumber(RoomObjectVariableEnum.const_1132,Number(_loc20_.isAdmin));
               }
      ...
      private function targetIsWarping(param1:IVector3d) : Boolean
      {
         ...
         if(Math.abs(_loc2_.x - param1.x) > const_750 || Math.abs(_loc2_.y - param1.y) > const_750)
         {
            return true;
         }
         return false;
