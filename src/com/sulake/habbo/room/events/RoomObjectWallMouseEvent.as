package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectWallMouseEvent extends RoomObjectMouseEvent
   {
      ...
      private var var_1460:Vector3d = null;
      
      private var var_1459:Vector3d = null;
      
      private var var_1461:Vector3d = null;
      ...
      public function RoomObjectWallMouseEvent(param1:String, param2:int, param3:String, param4:IVector3d, param5:IVector3d, param6:IVector3d, param7:Number, param8:Number, param9:Number, param10:Boolean = false, param11:Boolean = false)
      {
         ...
         var_1461.assign(param4);
         var_1459 = new Vector3d();
         var_1459.assign(param5);
         var_1460 = new Vector3d();
         var_1460.assign(param6);
         var_94 = param7;
         _y = param8;
         _direction = param9;
      }
