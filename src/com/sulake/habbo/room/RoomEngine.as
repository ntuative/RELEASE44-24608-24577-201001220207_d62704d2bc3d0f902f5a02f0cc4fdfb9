package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_746:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1052:String = "tile_cursor";
      ...
      private var var_640:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_958 = new Map();
         var_291 = new Map();
         var_74 = new RoomObjectEventHandler(this);
         var_640 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_74 != null)
         {
            ...
            {
               return var_74.deleteWallItem(var_119,var_120,param1);
            }
         }
         return false;
      }
      ...
      private function getRoomCanvas(param1:int, param2:int, param3:int) : IRoomRenderingCanvas
      {
         ...
         var _loc5_:IRoomInstance = var_50.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_716) - 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_134);
            if(_loc7_ != null)
            {
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_74.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_74 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_28)
            {
               return var_74.modifyWallItemData(var_119,var_120,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_50 != null)
         {
            var_50.release(new IIDRoomManager());
            var_50 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = var_50.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_879;
         ...
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_626);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_553);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_991);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_957);
      ...
      {
         var _loc4_:IRoomInstance = var_50.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1004) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_927);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_359,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_704,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_720,var_119,var_120,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_74 != null)
         {
            return var_74.modifyRoomObject(var_119,var_120,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_561,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_668,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_50 = param2 as IRoomManager;
         if(var_50 != null)
         {
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_30);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_35);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_243);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_63);
            var_50.setContentLoader(var_25);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_74 != null)
         {
            var_74.handleRoomObjectEvent(param1,var_119,var_120);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_202,_loc12_,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_782,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_973,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_888,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_510,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(_roomObjectFactory == null || var_393 == null || var_50 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_1813)
         {
            return;
         }
         var_50.initialize(<nothing/>,this);
      }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_272,RoomObjectCategoryEnum.const_63);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         if(isPublicRoomWorldType(_loc10_) && var_25 != null)
         {
            _loc12_ = var_25.getPublicRoomContentType(_loc10_) + "_";
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1244,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         if(var_50 != null)
         {
            var_50.update(param1);
         }
         updateRoomCameras(param1);
         var _loc2_:IRoomInstance = var_50.getRoom(getRoomIdentifier(var_119,var_120));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_748,RoomObjectCategoryEnum.const_243);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1145);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1145);
         if(_loc1_ != null)
         {
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_441,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_456,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_230,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_680,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_455,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_354,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_391,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_348,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_357,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_268,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_469,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_405,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_984,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_458,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_352,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_710) != 0)
         {
            return false;
         }
         if(var_74 != null)
         {
            return var_74.initializeRoomObjectInsert(var_119,var_120,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
      ...
      {
         return var_50.isContentAvailable(param1);
      }
      ...
      {
         if(var_25.insertObjectContent(param1,param2,param3))
         {
            return true;
         }
         return false;
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = var_50.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_202));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_370);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_696)
         {
            var_1813 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_202,_loc10_,false);
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_879,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      {
         var _loc5_:IRoomInstance = var_50.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_454.events.addEventListener(AdEvent.const_369,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_746) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_74 != null)
         {
            var_74.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(var_25 != null)
         {
            _loc7_ = var_25.getActiveObjectType(param1);
            _loc8_ = String(var_25.getActiveObjectColorIndex(param1));
         }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_74 != null)
         {
            return var_74.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc6_:IRoomInstance = var_50.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_50.getRoom(const_486);
         if(_loc10_ == null)
         {
            _loc10_ = var_50.createRoom(const_486,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_30:
            case RoomObjectCategoryEnum.const_28:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_202,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_370,param8);
               break;
            case RoomObjectCategoryEnum.const_35:
            ...
            case RoomObjectCategoryEnum.const_63:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_132,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_244,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_511,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_535,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_359,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         if(!isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_923,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_747,RoomObjectCategoryEnum.const_243);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1411 - _loc12_.width / 2;
               _loc11_.y = var_1410 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_371,var_119,var_120,-1,RoomObjectCategoryEnum.const_219));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_74 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_272,const_485);
                  var_74.handleRoomObjectEvent(_loc14_,var_119,var_120);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1145);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1411 - _loc6_.data.width / 2;
               _loc11_.y = var_1410 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      {
         return var_25.removeObjectContent(param1,param2,param3);
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_25 != null)
         {
            ...
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_878,param1.adWarningL,true);
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_864,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_946,RoomObjectVariableEnum.const_304,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_25 != null)
         {
            _events.addEventListener(RoomContentLoader.const_696,onContentLoaderReady);
      ...
      public function method_8() : void
      {
         if(var_74 != null)
         {
            var_74.method_8(var_119,var_120);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_50.getRoom(const_486);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_923);
      ...
      {
         return getRoomObjectBoundingRectangle(var_119,var_120,const_272,RoomObjectCategoryEnum.const_63,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = var_50.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_959,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_710,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_932,_loc13_,true);
            if(var_25 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_272,const_485,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_710,0,true);
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_561,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_668,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_359,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_206);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_626,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_553,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_626,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_553,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_991,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_957,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_747,const_1052,RoomObjectCategoryEnum.const_243);
         _loc7_.createRoomObject(const_748,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_243);
         return _loc7_;
      }
