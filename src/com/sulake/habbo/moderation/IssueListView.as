package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_61 = param3;
         var_1202 = param4;
         var_1401 = var_521.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1401 == null)
            {
               return;
            }
            _loc2_ = var_1401.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = var_61.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_521.assets.getAssetByName(_loc8_) as BitmapDataAsset;
