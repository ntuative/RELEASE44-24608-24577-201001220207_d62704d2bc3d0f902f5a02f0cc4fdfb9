package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1371:IIssueBrowserView;
      
      private const const_1595:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1593:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1370:IIssueBrowserView;
      
      private const const_1621:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1594:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_213:ITabContextWindow;
      
      private var var_1369:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_327.view.width = var_213.container.width;
         var_327.view.height = var_213.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1594:
               if(var_1370 == null)
               {
                  var_1370 = new MyIssuesView(issueManager,this,var_213.container);
               }
               return var_1370;
            case const_1595:
               if(var_1371 == null)
               {
                  var_1371 = new OpenIssuesView(issueManager,this,var_213.container);
               }
               return var_1371;
            case const_1593:
               if(var_1369 == null)
               {
                  var_1369 = new PickedIssuesView(issueManager,this,var_213.container);
               }
               return var_1369;
            default:
               return null;
