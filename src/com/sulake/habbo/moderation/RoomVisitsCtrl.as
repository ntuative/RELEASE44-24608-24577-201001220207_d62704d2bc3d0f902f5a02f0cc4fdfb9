package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(var_61.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = var_61.scrollableRegion.height > var_61.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1587.clone());
      ...
      {
         var_1587 = IWindowContainer(var_60.getXmlWindow("roomvisits_row"));
         ...
         var_61 = IItemListWindow(var_63.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1196;
      }
   }
}
