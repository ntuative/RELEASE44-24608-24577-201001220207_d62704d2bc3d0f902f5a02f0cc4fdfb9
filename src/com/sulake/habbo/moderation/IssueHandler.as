package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_972:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_66.issueManager.releaseBundle(var_122.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc1_:XmlAsset = var_66.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         _window = var_66.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(_window == null)
         {
            return;
         }
         ...
         var_66.disableButton(var_66.initMsg.chatlogsPermission,_window,"show_chatlog");
         ...
         var_386 = new UserInfoCtrl(_window,var_66,_loc3_.message);
         var_972 = new UserInfoCtrl(_window,var_66,_loc3_.message);
         var_386.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_122.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_972.load(_loc4_,var_122.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_66.issueManager.closeBundle(var_122.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = var_66.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = var_66.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_66.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_66,WindowTracker.const_962,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_66 != null && false && var_122 != null)
         {
            var_66.issueManager.removeHandler(var_122.id);
         }
         this.dispose();
      }
      ...
      {
         if(_window == null || var_66 == null || true)
         {
            return;
         }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_66.issueManager.closeBundle(var_122.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_66.issueManager.closeBundle(var_122.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = var_66.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = var_66.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
