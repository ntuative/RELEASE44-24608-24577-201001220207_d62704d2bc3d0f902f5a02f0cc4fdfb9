package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         onChatlog("Call For Help Chatlog: " + _loc2_.data.callId,WindowTracker.const_962,_loc2_.data.callId,_loc3_,_loc4_);
      }
      
      private function onIssueInfo(param1:IssueInfoMessageEvent) : void
      {
         if(param1 == null || var_66 == null)
         {
            return;
         }
         ...
         var_66.issueManager.playSound(_loc3_);
         var_66.issueManager.updateIssue(_loc3_);
         var_66.issueManager.updatePriorities();
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_935,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      ...
      private function onModeratorInit(param1:ModeratorInitMessageEvent) : void
      {
         ...
         {
            var_66.issueManager.updateIssue(_loc5_);
         }
         var_66.issueManager.updatePriorities();
         var_66.initMsg = _loc2_;
         var_66.startPanel.show();
      }
      ...
      private function onIssuePickFailed(param1:IssuePickFailedMessageEvent) : void
      {
         ...
         var_66.windowManager.alert("Error","Issue picking failed",0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_707,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      private function onModeratorActionResult(param1:ModeratorActionResultMessageEvent) : void
      {
         ...
         if(_loc2_.success)
         {
            var_66.connection.send(new GetModeratorUserInfoMessageComposer(_loc2_.userId));
         }
         else
         {
            var_66.windowManager.alert("Alert","Moderation action failed",0,onAlertClose);
         }
      }
      ...
      private function onIssueDeleted(param1:IssueDeletedMessageEvent) : void
      {
         ...
         var_66.issueManager.removeIssue(_loc2_.issueId);
      }
   }
}
