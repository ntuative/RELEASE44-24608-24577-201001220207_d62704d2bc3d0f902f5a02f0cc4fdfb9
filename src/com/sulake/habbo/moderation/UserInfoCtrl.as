package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_754:int = 31536000;
      
      private static const const_753:int = 86400;
      
      private static const const_751:int = 3600;
      
      private static const const_752:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_752) + " mins ago";
         }
         if(param1 < 2 * const_753)
         {
            return Math.round(param1 / const_751) + " hours ago";
         }
         if(param1 < 2 * const_754)
         {
            return Math.round(param1 / const_753) + " days ago";
         }
         return Math.round(param1 / const_754) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_60,WindowTracker.const_935,_data.userId),_callerFrame,var_963,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_797.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_60.getXmlWindow("user_info"));
            var_797.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new ModActionCtrl(var_60,_data.userId,_data.userName,var_1121),_callerFrame,var_963,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new RoomVisitsCtrl(var_60,_data.userId),_callerFrame,var_963,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new SendMsgsCtrl(var_60,_data.userId,_data.userName,var_1121),_callerFrame,var_963,false,true);
      }
