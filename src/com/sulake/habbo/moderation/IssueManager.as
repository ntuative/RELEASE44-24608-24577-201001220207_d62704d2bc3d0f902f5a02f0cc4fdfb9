package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_805:String = "issue_bundle_open";
      
      public static const const_583:String = "issue_bundle_my";
      ...
      private var var_521:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_131 = new Map();
         var_752 = new Map();
         var_521 = new IssueBrowser(this,var_66.windowManager,var_66.assets);
         var_614 = [];
         var_751 = [];
         var_912 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_912.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         var _loc2_:* = [];
         var _loc3_:int = var_66.sessionDataManager.userId;
         for each(_loc4_ in var_131)
         {
            switch(param1)
            {
               case const_805:
                  ...
                  break;
               case const_583:
                  if(_loc4_.state == IssueMessageData.const_465 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_614 = var_614.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1194)
         {
            var_162.remove(param1.issueId);
            return;
         }
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = new IssueHandler(var_66,_loc2_);
         var_912.remove(param1);
         var_912.add(param1,_loc3_);
         var_66.windowTracker.show(_loc3_,null,false,false,false);
         var_614 = [];
      }
      
      private function sendClose(param1:Array, param2:int) : void
      {
         if(param1 == null || var_66 == null || true)
         {
            return;
         }
         var_66.connection.send(new CloseIssuesMessageComposer(param1,param2));
      }
      ...
      private function sendPick(param1:Array) : void
      {
         ...
         var_66.connection.send(new PickIssuesMessageComposer(param1));
      }
      ...
      public function releaseAll() : void
      {
         ...
         var _loc1_:int = var_66.sessionDataManager.userId;
         var _loc2_:* = [];
         for each(_loc3_ in var_131)
         {
            if(_loc3_.state == IssueMessageData.const_465 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         if(param1 == null || param1.length == 0 || var_66 == null || true)
         {
            return;
         }
         var_66.connection.send(new ReleaseIssuesMessageComposer(param1));
      ...
      {
         var _loc2_:* = var_912.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function updatePriorities() : void
      {
         ...
         var _loc3_:int = parseInt(var_66.configuration.getKey("chf.score.updatefactor","60"));
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_66.soundManager.playSound(HabboSoundTypesEnum.const_810);
         }
      }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         var _loc4_:int = var_66.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_465 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
