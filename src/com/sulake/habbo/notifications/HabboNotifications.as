package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1112:String = "badges";
      
      private static const const_1115:String = "pixelbalance";
      
      private static const const_1109:String = "credits";
      
      private static const const_1110:String = "inventory";
      
      private static const const_1114:String = "friendlist";
      
      private static const const_1111:String = "selectfurni";
      
      private static const const_1113:String = "selectbadge";
      ...
      private var var_1298:IHabboToolbar;
      ...
      private var var_419:HabboNotificationViewManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_872);
         }
         var _loc6_:Map = var_872["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1267);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1003)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2179)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_967);
            var_2179 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1154.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_818,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_166 || param2.type == WindowEvent.const_536)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(param1 != null && this.var_419 != null)
         {
            var_419.replaceIcon(param1);
         }
      }
      ...
      {
         if(var_419.isSpaceAvailable() && false)
         {
            var_419.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1154.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_589);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc16_ = var_589.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc16_ = var_589.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_589.getProductData(_loc4_.localizationId);
               switch(_loc15_.productType)
               {
                     ...
                     else
                     {
                        switch(_loc18_)
                        {
                           case FurniCategory.const_327:
                              _loc17_ = (var_26 as Component).assets.getAssetByName("icon_wallpaper_png") as BitmapDataAsset;
                              if(_loc17_ != null)
                              {
                           ...
                           case FurniCategory.const_325:
                              _loc17_ = (var_26 as Component).assets.getAssetByName("icon_landscape_png") as BitmapDataAsset;
                              if(_loc17_ != null)
                              {
                                 _loc5_ = (_loc17_.content as BitmapData).clone();
                              }
                           ...
                           case FurniCategory.const_308:
                              _loc17_ = (var_26 as Component).assets.getAssetByName("icon_floor_png") as BitmapDataAsset;
                              if(_loc17_ != null)
                              {
                                 _loc5_ = (_loc17_.content as BitmapData).clone();
                              }
                  ...
                  case CatalogPageMessageProductData.const_218:
                     _loc17_ = (var_26 as Component).assets.getAssetByName("fx_icon_" + _loc15_.furniClassId + "_png") as BitmapDataAsset;
                     if(_loc17_ != null)
                     {
                        _loc5_ = (_loc17_.content as BitmapData).clone();
                     }
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_967,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1154.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      {
         var_1298 = IHabboToolbar(param2);
         var_1298.events.addEventListener(HabboToolbarEvent.const_85,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_589.userId == _loc2_.userId)
         {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_85)
         {
            ...
            var_419 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_872["styles"],var_872["view"],var_1298);
            ...
            registerUpdateReceiver(var_419,1);
            registerUpdateReceiver(this,2);
            var_589.events.addEventListener(BadgeImageReadyEvent.const_119,onBadgeImage);
            var_1298.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
