package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_2014 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_589 != null)
         {
            var_589.events.removeEventListener(BadgeImageReadyEvent.const_119,onBadgeImageReady);
            var_589 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_680,var_2014);
               }
               dispose();
               break;
      ...
      private function registerBadgeParameters(param1:String) : void
      {
         ...
         _localizations.registerParameter(param1,"level",var_1647.toString());
         _localizations.registerParameter(param1,"name",var_589.userName);
         _localizations.registerParameter(param1,"realname",var_589.realName);
      }
   }
}
