package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1399:uint = 0;
      ...
      private const const_1615:uint = 4.282169599E9;
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(var_666 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_666 % 2) ? uint(const_1399) : uint(const_1398);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1615;
            var_666 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1399) : uint(const_1398);
