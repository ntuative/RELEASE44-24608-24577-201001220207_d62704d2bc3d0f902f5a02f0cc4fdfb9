package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_402:String = "CPV_MODE_TRIAL";
      
      public static const const_1222:String = "CPV_MODE_FULL";
      ...
      private const const_1074:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1074,_loc7_,"image/png");
      ...
      {
         _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_606));
      }
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1074))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1074) as BitmapDataAsset;
            if(!_loc2_)
            {
               return false;
            }
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_689,_loc2_.text,var_637 == const_402);
