   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_734 = _window.findChildByName("effect_hilite");
            var_734.visible = false;
         }
         var_735 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_733 = _window.findChildByName("loader_bar");
         if(var_733 != null)
         {
            var_399 = var_733.width;
            var_169.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_735 != null)
         {
            var_735.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_735.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
