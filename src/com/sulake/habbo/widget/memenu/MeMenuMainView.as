      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_592);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_903));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_247);
               break;
            case "hc":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","UserCountRenderer") == "true";
               if(false && _loc4_)
               {
