package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1402:Number = 10;
      
      private static const const_1403:Number = 8;
       
      
      private var var_1216:Number;
      ...
      {
         _widget.onItemMouseOut(var_995,var_993,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_995,var_993,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1214 = param1.chatType;
         var_995 = param1.userId;
         var_831 = param1.userName;
         var_993 = param1.userCategory;
         _message = param1.text;
         var_1216 = param1.userX;
         var_202 = param1.userImage;
         var_994 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1214)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_242:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_238:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_202 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_202.height);
         }
         ...
         var_107 = _window as IRegionWindow;
         var_107.background = true;
         var_107.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_107);
         ...
         if(var_202 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_202.width;
               _loc28_.height = var_202.height;
               _loc28_.bitmap = new BitmapData(var_202.width,var_202.height,true,0);
               _loc28_.bitmap.copyPixels(var_202,var_202.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_397 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_202.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_994 != 0)
            {
               _loc30_ = uint(var_994 >> 16 & 255);
               _loc31_ = uint(var_994 >> 8 & 255);
               _loc32_ = uint(var_994 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1214 == RoomWidgetChatUpdateEvent.const_242)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_831);
            }
            else if(var_1214 == RoomWidgetChatUpdateEvent.const_238)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_831);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_336 + _loc20_.textWidth + const_488;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_995,var_993,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_995,var_993,_roomId,_roomCategory,param1);
      }
