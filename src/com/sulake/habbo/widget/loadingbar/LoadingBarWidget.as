package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_395:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_395 = new Sprite();
            var_395.addChild(new Bitmap(_image));
            var_395.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_395.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_395);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1475 != "")
         {
            HabboWebTools.openWebPage(var_1475);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_395 != null)
         {
            var_395.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_395 = null;
         }
         if(_image != null)
         {
