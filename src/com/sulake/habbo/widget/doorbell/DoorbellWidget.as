package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_727,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_116,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_107,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_727,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_116,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_107,onDoorbellHandled);
      }
