package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_616:Array = null;
      ...
      private var var_1305:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1305 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_281,update);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(var_61.scrollableRegion.height - 0,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         var_61 = _window.findChildByName("choices") as IItemListWindow;
         if(var_61 == null)
         {
            return false;
         }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1963;
         if(_loc2_ > var_1305)
         {
            vote();
            return;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(var_61.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_61.numListItems)
         {
            _loc4_ = var_61.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         {
            _loc2_ = var_61.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_281,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1305 - param1) / 1000,0);
