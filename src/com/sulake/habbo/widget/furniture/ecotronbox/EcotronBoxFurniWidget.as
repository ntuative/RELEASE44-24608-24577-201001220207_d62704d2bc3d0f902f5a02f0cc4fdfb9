package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc1_:* = null;
         if(var_222 || var_160 == -1 || !_controller)
         {
            return;
         }
         var_222 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_611,var_160);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1023,const_1022,2,2),null,0) as IWindowContainer;
