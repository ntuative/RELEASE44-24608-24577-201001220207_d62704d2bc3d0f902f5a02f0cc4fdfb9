package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_452:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1023,const_1022,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_452 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_452 != null)
         {
            var_452.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_941 = _loc2_.light;
         if(var_334 != null)
         {
            var_334.setValue(var_941);
         }
         var_402 = colors.indexOf(_loc2_.color);
         if(var_452 != null)
         {
            var_452.setSelectedColorIndex(var_402);
         }
