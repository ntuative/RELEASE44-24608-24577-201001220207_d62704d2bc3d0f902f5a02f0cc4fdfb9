package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_423.destroyGridItems();
         var_297 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1313) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_883.width,var_883.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_717.width,var_717.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_717,var_717.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_423.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_423.numGridItems)
         {
            return;
         }
         select(var_423.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_883 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         var_717 = BitmapData(_loc3_.content);
      }
