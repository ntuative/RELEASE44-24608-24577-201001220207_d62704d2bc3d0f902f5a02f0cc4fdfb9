package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2078:IContainerButtonWindow;
      
      private var var_2077:IContainerButtonWindow;
      
      private var var_2079:IContainerButtonWindow;
      
      private var var_2080:IContainerButtonWindow;
      
      private var var_322:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_322 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_2077 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2079 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2078 = initButton("room_invite",onInviteButtonClick,param1);
         var_2080 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_322.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_322.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_29)
         {
            this.var_322.closePopup();
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2077,isEnableMinimailButton(_loc1_));
         setEnabled(var_2079,isEnableHomeButton(_loc1_));
         setEnabled(var_2078,isEnableInviteButton(_loc1_));
         setEnabled(var_2080,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = var_61.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
