package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_218.length / const_326);
      }
      ...
      {
         if(this.var_783 >= this.getPageCount())
         {
            this.var_783 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_783 + 1) * const_326,this.var_218.length);
      }
