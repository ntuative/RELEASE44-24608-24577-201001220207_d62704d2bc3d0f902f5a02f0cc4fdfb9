package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_368:IFriendRequestsDeps;
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_857;
         var_368.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         var _loc2_:* = null;
         var _loc1_:* = true;
         for each(_loc2_ in var_495)
         {
            _loc1_ = !_loc1_;
            var_368.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      {
         var_495.push(param1);
         var_368.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            Util.remove(var_495,_loc4_);
            if(false)
            {
               var_368.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
