package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1884:IAvatarRenderManager;
      
      private var var_1420:AvatarSearchResults;
      
      private var var_130:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_805:FriendRequests;
      ...
      private var var_1891:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1421:OpenedToWebPopup;
      ...
      {
         var_1890 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_338 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1420 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1421 == null)
         {
            var_1421 = new OpenedToWebPopup(this);
         }
         var_1421.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_805.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_805.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_408.findTab(FriendListTab.const_94).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_805.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_208.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_805 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_338.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_338.addCategory(new FriendCategory(FriendCategory.const_839,getText("friendlist.friends")));
         var_338.addCategory(new FriendCategory(FriendCategory.const_430,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_338.addFriend(new Friend(_loc4_));
         }
         var_408 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_208.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var _loc2_:IAvatarImage = var_1884.createAvatarImage(param1,AvatarScaleType.const_98);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1884 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_805.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_408.findTab(FriendListTab.const_94);
      ...
      {
         var_1891 = param2 as IHabboNotifications;
      ...
      {
         var _loc1_:String = var_180.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_408.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         var_208 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         return var_180.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1420.searchReceived(_loc2_.friends,_loc2_.others);
