package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1404:String = "no_reqs_info";
       
      
      private var var_1486:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_320 && _loc4_.state != FriendRequest.const_321)
            {
      ...
      {
         var_1486 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1485 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1485.procedure = onDismissAllButtonClick;
         var_1486.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_857)
         {
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         var_61.removeListItem(param1.view);
         refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         var_61.addListItem(param1.view);
         _friendList.friendRequests.refreshShading();
         refreshButtons();
      }
