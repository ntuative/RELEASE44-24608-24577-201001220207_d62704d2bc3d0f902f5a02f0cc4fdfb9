package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_210 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_920,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1051 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1051)
         {
         ...
         var_1312 = _loc7_.toolbar.@margin_bottom;
         var_1543 = _loc7_.toolbar.@min_group_margin;
         var_1544 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_284,param1,param2,_window,var_259);
         createGroupsFromXmlList(_loc9_,var_595,param1,param2,var_210,var_259);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_150,var_508,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1543,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1312) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1543,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1312) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_150,var_508);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_508);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_150,var_508);
         }
      }
