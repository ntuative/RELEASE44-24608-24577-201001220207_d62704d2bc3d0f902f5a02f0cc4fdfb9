package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1044:Number = 90;
      ...
      private var var_1036:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1036 = param2;
         var_588 = new Timer(const_1043);
         var_588.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_503.push(param2);
         param1.addEventListener(WindowEvent.const_378,windowEventListener);
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1036.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1036.getIconLoc(param1.iconId);
      ...
      {
         return param1.x + param1.width < const_774 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_774 || param1.desktop.height - param1.y < const_1103;
      }
