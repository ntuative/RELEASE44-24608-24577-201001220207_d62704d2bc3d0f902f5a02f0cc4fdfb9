   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_873.push(new XML());
               var_874.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_874[var_63] = param6.clone();
         }
      ...
      {
         if(var_1299 == true || var_710 == 0)
         {
            if(false)
            {
               ++var_63;
               if(var_63 >= var_873.length)
               {
                  var_63 = 0;
                  ++var_710;
               }
      ...
      {
         return var_873.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1299 == false && var_710 == 1 && var_1146 != var_46;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_63 <= var_874.length)
         {
            _loc2_ = var_874[var_63];
