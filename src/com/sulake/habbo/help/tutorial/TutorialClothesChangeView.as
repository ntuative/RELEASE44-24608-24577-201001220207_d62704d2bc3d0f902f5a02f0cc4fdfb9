package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_60.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_46,onShowMenuEvent);
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_46)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_60.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_450));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_544 = var_60.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_544.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_60.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU_ARROW,var_544));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_60.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_46,onShowMenuEvent);
      }
   }
}
