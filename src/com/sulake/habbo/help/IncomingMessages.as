package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_44.tellUI(HabboHelpViewEnum.const_187,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_44.tellUI(HabboHelpViewEnum.const_239,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_44.tellUI(HabboHelpViewEnum.const_140);
      }
      ...
      {
         var_44.showUI(HabboHelpViewEnum.const_296);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_44.showUI(HabboHelpViewEnum.const_362);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_44.showUI(HabboHelpViewEnum.const_603);
         var_44.tellUI(HabboHelpViewEnum.const_603,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_423)
            {
         ...
         var_44.tellUI(HabboHelpViewEnum.const_515);
      }
