package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2305:String = "magic.pixels";
      
      private var var_2304:String = "catalog.page.club";
      
      private var var_2339:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_281 = [];
         var_61 = _container.findChildByName("navigationList") as IItemListWindow;
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_582,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_225,activateScrollbar);
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_96.configuration.getKey("client.credits.embed.enabled","UserCountRenderer") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_96.configuration.getKey("link.format.credits","/credits");
            var_96.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_96.openCatalogPage(var_2304,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_96.loadCatalogPage(param1.pageId);
         var_96.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_61);
            }
         }
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_96.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_96.loadCatalogPage(_loc2_.pageId);
         }
