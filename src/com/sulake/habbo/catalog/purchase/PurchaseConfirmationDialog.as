package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1399:uint = 4.294967295E9;
      
      private const const_1398:uint = 4.293848814E9;
      ...
      private var var_497:IWindowContainer;
      ...
      private var var_96:HabboCatalog;
      ...
      public function receiverNotFound() : void
      {
         ...
         var_96.windowManager.alert("${catalog.gift_wrapping.receiver_not_found.title}","${catalog.gift_wrapping.receiver_not_found.info}",0,alertHandler);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         return var_96.windowManager.buildFromXML(_loc2_.content as XML);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_849;
               }
            }
            _loc4_++;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = var_96.getProductData(var_88.localizationId);
         var _loc2_:String = _loc1_ == null ? "" : _loc1_.name;
         var_96.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","offer_name",_loc2_);
         var _loc3_:String = "";
         var _loc4_:String = "";
         var _loc7_:String = var_96.getPurse().credits.toString();
         var _loc8_:String = var_96.getPurse().pixels.toString();
         switch(var_88.priceType)
         {
            case Offer.const_468:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits";
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_88.priceInCredits.toString());
               _loc3_ = _loc5_.value;
            ...
            case Offer.const_367:
               ...
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_88.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_88.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
         ...
         var_96.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","price",_loc3_);
         var_96.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.amount","amount",_loc4_);
      }
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_88.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(var_849,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1398) : uint(const_1399);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1346;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = var_96.getFurnitureData(_loc6_,ProductTypeEnum.const_73);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               var_96.purchaseProduct(var_669,var_88,var_1025);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_849);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_580[var_206]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_581[var_207]);
         var_96.purchaseProductAsGift(var_669,var_88,var_1025,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = var_96.getProductData(var_88.localizationId);
            _loc1_.text = _loc3_ == null ? "" : _loc3_.name;
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByName("product_image") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc4_ = var_88.page.viewer.roomEngine;
            _loc6_ = var_88.productContainer.firstProduct;
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_218:
                  _loc7_ = var_96.getPixelEffectIcon(_loc6_.productClassId);
                  break;
               case ProductTypeEnum.const_384:
                  _loc7_ = var_96.getSubscriptionProductIcon(_loc6_.productClassId);
            }
            if(_loc5_ != null)
            {
               _loc7_ = _loc5_.data;
      ...
      private function showGiftDialog() : void
      {
         ...
         var _loc1_:GiftWrappingConfiguration = var_96.giftWrappingConfiguration;
      ...
      private function setBitmapData(param1:IWindowContainer, param2:String, param3:String, param4:ColorTransform = null) : void
      {
         ...
         var _loc6_:BitmapDataAsset = var_96.assets.getAssetByName(param3) as BitmapDataAsset;
         if(_loc6_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_497 == null)
         {
            var_497 = createWindow("suggestion_list_item") as IWindowContainer;
            var_497.procedure = suggestionsEventHandler;
         }
         if(var_238 == null || var_497 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_238.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_497.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
