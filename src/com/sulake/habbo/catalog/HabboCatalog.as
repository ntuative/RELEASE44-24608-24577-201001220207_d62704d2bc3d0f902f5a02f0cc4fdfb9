package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_333:ICatalogViewer;
      ...
      private var var_1771:GiftWrappingConfiguration;
      ...
      public function returnInventoryFurniFromRecycler(param1:int) : Boolean
      {
         ...
         return var_26.returnInventoryFurniFromRecycler(param1);
      }
      
      public function getProductData(param1:String) : IProductData
      {
         return var_589.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1769 && var_781 != null)
         {
            var_781.playSound(HabboSoundTypesEnum.const_974);
         }
         var_1769 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_589.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_77)
         {
            _loc3_ = var_589.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_88:
               var_1134 = param1.session.isPrivateRoom;
               if(var_90 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_180.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_180.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1771 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_208.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      public function openInventoryCategory(param1:String) : void
      {
         ...
         var_26.toggleInventoryPage(param1);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_377 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_136.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_136 == null)
         {
            var_136 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_180 = param2 as IHabboConfigurationManager;
      }
      ...
      {
         var _loc2_:BitmapDataAsset = (var_26 as Component).assets.getAssetByName("fx_icon_" + param1 + "_png") as BitmapDataAsset;
         if(_loc2_ != null)
         {
            return (_loc2_.content as BitmapData).clone();
         }
      ...
      {
         var_208.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      public function requestInventoryFurniToRecycler() : int
      {
         ...
         return var_26.requestSelectedFurniToRecycler();
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_377.buildCatalogIndex(_loc2_);
         if(var_940 != "")
         {
            var_377.openPage(var_940);
            var_940 = "";
         }
         else
         {
            var_377.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_166)
         {
            _loc3_ = var_180.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_333 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_333.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_333.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1770 && var_781 != null)
         {
            var_781.playSound(HabboSoundTypesEnum.const_875);
         }
         var_1770 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_333.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_333.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_333 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
      
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var _loc3_:IRoomSessionManager = IRoomSessionManager(param2);
         _loc3_.events.addEventListener(RoomSessionEvent.const_88,onRoomSessionEvent);
