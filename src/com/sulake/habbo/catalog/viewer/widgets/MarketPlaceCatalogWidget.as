package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1080:MarketPlaceOfferData;
      
      private const const_1590:int = 10;
      
      private const const_1385:int = 1;
      
      private const const_1589:int = 40;
      
      private const const_1384:int = 2;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         var _loc3_:IItemListWindow = window.findChildByName("offer_list") as IItemListWindow;
         if(!_loc3_)
         {
            return;
         }
         ...
         updateStatusDisplay(const_1384,_loc7_.length);
         var _loc8_:int = 0;
            ...
            if(_loc10_ != null)
            {
               ...
               if(!(!_loc11_ || _loc11_.disposed))
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     _loc16_ = _loc16_.replace("%price%",_loc10_.price);
                     _loc16_ = _loc16_.replace("%average%",_loc10_.averagePrice != 0 ? _loc10_.averagePrice.toString() : " - ");
                     _loc14_.text = _loc16_;
                  }
                  _loc15_ = _loc11_.findChildByName("offer_count") as ITextWindow;
                  if(_loc15_)
                  {
                     _loc17_ = _loc2_.getKey("catalog.marketplace.offer_count");
                     _loc17_ = _loc17_.replace("%count%",_loc10_.offerCount);
                     _loc15_.text = _loc17_;
                  }
                  if(_loc10_.image == null)
                  {
                     _loc18_ = getFurniImageResult(_loc10_.furniId,_loc10_.furniType);
                     if(_loc18_ != null && _loc18_.data != null)
                     {
                        _loc10_.image = _loc18_.data as BitmapData;
                        _loc10_.imageCallback = _loc18_.id;
                     }
                  }
                  if(_loc10_.image != null)
                  {
                     _loc19_ = _loc11_.findChildByName("item_image") as IBitmapWrapperWindow;
                     if(_loc19_ != null)
                     {
                        _loc20_ = new Point((_loc19_.width - _loc10_.image.width) / 2,(_loc19_.height - _loc10_.image.height) / 2);
                        if(_loc19_.bitmap == null)
                        {
                           _loc19_.bitmap = new BitmapData(_loc19_.width,_loc19_.height,true,0);
                        }
                        _loc19_.bitmap.copyPixels(_loc10_.image,_loc10_.image.rect,_loc20_);
                     }
                  }
                  _loc3_.addListItem(_loc11_);
                  _loc11_.procedure = onOfferListEvent;
               }
            }
            _loc8_++;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1080.offerId);
                  hideDetails();
            }
            return;
         }
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1385);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < _sortTypes.length)
         {
            _loc4_ = 0;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(_sortTypes));
            _loc7_.selection = 0;
         }
      }
      ...
      private function onOfferListEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc3_ = window.findChildByName("offer_list") as IItemListWindow;
            if(_loc3_ == null)
            {
               return;
            }
