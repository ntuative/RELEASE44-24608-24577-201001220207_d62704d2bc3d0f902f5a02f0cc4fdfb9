package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_402 >= var_304.length)
         {
            return "";
         }
         var petColor:IPetColor = var_304[var_402] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_563[var_1482] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_402 < 0 || var_402 > var_304.length)
         {
            var_402 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_919.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         var_837 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_304 = [];
         var_563 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_837);
               if(_loc11_)
               {
         ...
         while(_loc6_ < var_563.length)
         {
            ...
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_837,_loc12_.id),getRaceLocalizationKey(var_837,_loc12_.id)));
            _loc6_++;
         }
         var_919.add(var_837,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_824,onApproveNameResult);
         _loc5_ = var_919.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_919.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_402 >= 0 && var_402 < var_304.length)
         {
            _loc7_ = var_304[var_402] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_563[var_1482] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_837,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_280,AvatarAction.const_508);
