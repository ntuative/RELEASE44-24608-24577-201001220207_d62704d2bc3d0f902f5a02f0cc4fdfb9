package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1078 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_297 = null;
         for each(_loc1_ in var_1079)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1078) as IWindowContainer;
            _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc2_.background = true;
            _loc2_.color = 4294967295;
            _loc2_.width = var_609.width;
            _loc2_.height = var_609.height;
            _colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_609.width,var_609.height,true,0);
               _loc3_.bitmap.copyPixels(var_609,var_609.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_908.width,var_908.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_908,var_908.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_908 = _loc4_.content as BitmapData;
         populateColourGrid();
