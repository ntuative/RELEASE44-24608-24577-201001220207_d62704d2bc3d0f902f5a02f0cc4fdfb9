package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         super(param1);
         var_891 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = var_1363.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         var _loc1_:String = var_1363.getValue(var_756.productContainer.firstProduct.extraParam.toLowerCase());
