package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1218:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_1218 != null)
         {
            var_1218.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1306.text = "${" + _loc3_.name + "}";
            var_1307.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1306.text = "${" + _loc2_.localizationId + "}";
            var_1307.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_375:
                  _loc4_ = var_1217.clone();
                  if(var_559 != null)
                  {
                     var_559.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_559,var_1218,var_1326);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_218:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_280,AvatarAction.const_688);
                              _loc13_.appendAction(AvatarAction.const_495,_loc6_.productClassId);
      ...
      {
         var_1306 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1307 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_92 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1476 = new Point(var_92.x,var_92.y);
         var_559 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1218 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_559 == null)
         {
         ...
         var_1217 = _loc2_.content as BitmapData;
