package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_936 != null)
         {
            var_936.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_937 != null)
         {
            var_937.removeEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_936 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_936 != null)
         {
            var_936.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_937 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_937 != null)
         {
            var_937.addEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
