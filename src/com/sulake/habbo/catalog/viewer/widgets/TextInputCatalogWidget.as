package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_909:ITextFieldWindow;
      ...
      {
         super.init();
         var_909 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_909 != null)
         {
            var_909.addEventListener(WindowKeyboardEvent.const_715,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_909.text));
      }
   }
}
