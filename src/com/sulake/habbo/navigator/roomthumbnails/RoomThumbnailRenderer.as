package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private var var_772:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_772 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_772.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         var _loc5_:BitmapData = _loc3_.method_5();
         if(_loc5_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1049,_loc4_.y + const_1050 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1750[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_772.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_772.getImage(ThumbnailEditorModel.const_36,1);
         }
         var _loc4_:BitmapData = _loc3_.method_5();
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_772.getImage(ThumbnailEditorModel.const_53,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_744 + _loc3_,param2 * const_1048);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_438)
         {
            if(false)
            {
               refreshObj(param1,var_939[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1130 == null)
         {
            var_1130 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1130,var_1130.rect,new Point(0,0),null,null,true);
      }
   }
}
