package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2213:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1546,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1545,this._model.mode != ThumbnailEditorModel.const_33);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1546 = IButtonWindow(find("top_tab"));
         var_1545 = IButtonWindow(find("obj_tab"));
         var_2213 = IWindowContainer(find("tile_grid"));
         var_2214 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1546,onTopTabButton);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2213;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2214;
