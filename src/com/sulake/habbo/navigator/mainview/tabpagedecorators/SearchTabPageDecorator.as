package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1474:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_197,Tabs.const_193,"-1",MainViewCtrl.const_505);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1474 == null)
         {
            ...
            var_1474 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1474.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
