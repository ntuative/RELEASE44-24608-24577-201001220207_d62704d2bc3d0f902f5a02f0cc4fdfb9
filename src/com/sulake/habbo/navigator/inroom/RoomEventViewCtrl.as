package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_630:TextFieldManager;
      
      private var var_1396:IWindowContainer;
      
      private var var_1767:ITextWindow;
      
      private var var_1133:IButtonWindow;
      
      private var var_776:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_630.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_775.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1767.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_630.setText(param1.eventDescription);
         var_775.setText(getTagFromEvent(param1,1));
         var_777.setText(getTagFromEvent(param1,2));
         var_1131.visible = false;
         var_1132.visible = true;
         var_1133.visible = true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1396 = IWindowContainer(find("event_type_disabled_cont"));
            var_1767 = ITextWindow(find("event_type_disabled_text"));
            var_1395 = ITextWindow(find("create_caption"));
            var_1394 = ITextWindow(find("edit_caption"));
            var_1131 = IButtonWindow(find("create_button"));
            var_1132 = IButtonWindow(find("edit_button"));
            var_1768 = IButtonWindow(find("cancel_button"));
            var_1133 = IButtonWindow(find("end_button"));
            var_776 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1131,onCreateButtonClick);
            Util.setProcDirectly(var_1132,onEditButtonClick);
            Util.setProcDirectly(var_1133,onEndButtonClick);
            Util.setProcDirectly(var_1768,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_630 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_775 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_777 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_630.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_1131.visible = true;
         var_1132.visible = false;
         var_1133.visible = false;
         var_630.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_775.goBackToInitialState();
