package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2310:Dictionary;
      ...
      private var var_1578:ISessionDataManager;
      
      private var var_1577:RoomCreateViewCtrl;
      
      private var var_1576:RoomThumbnailRenderer;
      
      private var var_208:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1073:RoomInfoViewCtrl;
      
      private var var_96:IHabboCatalog;
      
      private var var_408:Tabs;
      
      private var var_432:MainViewCtrl;
      
      private var var_1579:Array;
      
      private var var_1030:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_432 = new MainViewCtrl(this);
         var_1073 = new RoomInfoViewCtrl(this);
         var_1577 = new RoomCreateViewCtrl(this);
         var_1576 = new RoomThumbnailRenderer(this);
         var_1030 = new GuestRoomPasswordInput(this);
         var_341 = new GuestRoomDoorbell(this);
         var_408 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_432.startSearch(Tabs.const_197,Tabs.const_295,param1);
         var_432.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_208 != null)
         {
            var_208.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_180.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_208 != null)
         {
            var_208.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_208.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1578 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_432.startSearch(Tabs.const_256,Tabs.const_215);
         var_408.getTab(Tabs.const_256).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_432.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
