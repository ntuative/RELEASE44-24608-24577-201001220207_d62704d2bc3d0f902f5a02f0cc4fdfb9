package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1576 = new RoomThumbnailRenderer(param1);
         var_1042 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_185,var_125.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_1042.refreshTags(_loc1_,var_125.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1576.refreshThumbnail(_loc1_,var_125.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_185,var_125);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_185,!true ? getEventCtg(var_125.categoryId) : getRoomCtg(var_125.categoryId));
         refreshRoomDesc(var_185,var_125);
         refreshExtraCont();
         refreshInfo(var_185,"trading_allowed",var_125.allowTrading);
         refreshInfo(var_185,"doormode_doorbell",false);
         refreshInfo(var_185,"doormode_password",false);
         Util.moveChildrenToColumn(var_185,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_197,Tabs.const_193,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
