package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2016:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1480:ILogger;
      
      private var var_1227:String;
      
      private var var_2015:String;
      
      private const const_1388:String = "fuselogin";
      
      private var var_552:ICoreCommunicationManager;
      
      private var var_480:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_309:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2017)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_681 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_681);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1227,var_2015));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1388,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_480.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_480.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2016);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1388,"/");
      ...
      {
         var_681 = _habboConfiguration.getKey("sso.ticket",null);
         var_1227 = _habboConfiguration.getKey("flash.client.url","");
         var_2015 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_681 != null)
         {
            var_80.mode = HabboConnectionType.const_414;
            var_80.initConnection(HabboConnectionType.const_245);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1480 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_570);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2016 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_80.mode)
         {
            case HabboConnectionType.const_414:
               _loc6_ = "";
               ...
               var_1006 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1006,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1207:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1202:
               var_1005 = generateRandomHexString(30);
               var_480 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_480.init(var_1005);
               _loc8_ = var_480.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var_480 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_1005 = generateRandomHexString(30);
            var_480.init(var_1005);
            _loc12_ = var_480.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_22,onConfigurationLoaded);
         }
      }
