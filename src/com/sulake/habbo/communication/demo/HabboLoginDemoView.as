package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_598:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_330.shockwaveClientUrl = var_118.shockwaveClientUrl;
         var_330.ssoTicket = var_118.ticket;
         var_118.removeEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_118.removeEventListener(SSOTicket.const_261,onParsedTicketFailure);
         var_118 = null;
         dispatchEvent(new Event(const_598));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1388,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_330.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_407,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1388,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_118 = new SSOTicket(var_330.assets,_loc2_,_loc1_);
         var_118.addEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_118.addEventListener(SSOTicket.const_261,onParsedTicketFailure);
      }
