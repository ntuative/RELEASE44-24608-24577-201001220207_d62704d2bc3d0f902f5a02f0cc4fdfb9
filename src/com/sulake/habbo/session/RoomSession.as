package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1040:UserDataManager;
      ...
      {
         if(var_46 == RoomSessionEvent.const_282 && _connection != null)
         {
            var_46 = RoomSessionEvent.const_88;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1040 as IUserDataManager;
      }
