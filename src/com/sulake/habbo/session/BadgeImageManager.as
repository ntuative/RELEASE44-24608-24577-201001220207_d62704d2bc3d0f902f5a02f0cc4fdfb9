package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1264:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_784:String = "group_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1264:
               if(var_180 != null)
               {
                  _loc5_ = var_180.getKey("image.library.url","http://images.habbohotel.com/c_images/");
            ...
            case const_784:
               if(var_180 != null)
               {
                  if(var_180 != null)
                  {
                     _loc5_ = var_180.getKey("group.badge.url");
