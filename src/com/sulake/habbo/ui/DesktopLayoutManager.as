package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1622:String = "room_desktop_layout_container";
      
      private const const_1033:String = "room_view";
      
      private var var_617:int = 50;
      
      private var var_2244:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_71.getChildByTag(const_1033) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_71.findChildByTag(const_1033) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_617;
               _loc2_.width = var_71.desktop.width - var_617;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_617;
               _loc2_.height = var_71.desktop.height - var_617;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_71.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_71.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_312,trimContainer);
            }
            _loc5_++;
         }
      }
