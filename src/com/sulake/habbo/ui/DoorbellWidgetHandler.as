package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_101:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_727,_loc2_.userName));
               break;
            ...
            case RoomSessionDoorbellEvent.const_107:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_107,_loc2_.userName));
               break;
         }
      }
      ...
      {
         return [RoomSessionDoorbellEvent.const_101,RoomSessionDoorbellEvent.const_116,RoomSessionDoorbellEvent.const_107];
      }
