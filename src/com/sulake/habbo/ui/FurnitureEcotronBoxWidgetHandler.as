package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_630,RoomWidgetEcotronBoxOpenMessage.const_611,RoomWidgetEcotronBoxOpenedMessage.const_1190];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_630:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_611:
