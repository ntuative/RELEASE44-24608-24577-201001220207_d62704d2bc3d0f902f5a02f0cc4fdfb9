package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_446:Point = null;
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(var_622.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_290:
      ...
      {
         return [RoomWidgetChatMessage.const_531,RoomWidgetChatSelectAvatarMessage.const_671];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_531:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_151,_container.roomSession,0,"Version 24608-24577-201001220139");
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_434);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_671:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_763 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_763);
            }
            if(var_446 == null)
            {
               var_445.x = 0;
               var_445.y = 0;
               var_445.z = 0;
               var_446 = _loc4_.getScreenPoint(var_445);
               var_763 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_445.x = 0;
            var_445.y = 0;
            var_445.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_445);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_446.x || _loc8_.y != var_446.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_446,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_285;
      }
