package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_2130:BitmapData = null;
      ...
      private var var_2131:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_369,0,0,_loc4_,var_1518,var_2131,var_2130));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2132 = int(_config.getKey("interstitial.interval","30000"));
         var_2133 = int(_config.getKey("interstitial.show.time","5000"));
         var_1520 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1518 = _loc2_.clickUrl;
         if(var_1274 != "" && var_1518 != "")
         {
            _loc3_ = var_1274;
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_424,0,0,param1.bitmapData,var_2129));
            var_699 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2130 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1520 > 0 && var_1519 >= var_1520)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_699;
         if(_loc1_ > var_2132)
         {
            ++var_1519;
      ...
      {
         var_552 = param2 as IHabboCommunicationManager;
         if(var_552 == null)
         {
            return;
         }
         _connection = var_552.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2131 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
