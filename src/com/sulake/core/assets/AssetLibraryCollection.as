package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1062:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_45 = new Array();
         var_512 = new Array();
         var_1062 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_361 = new AssetLibrary("lib-" + var_603++);
         var_45.push(var_361);
      }
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_512.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_603++);
         var_512.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < var_512.length)
            {
               _loc3_ = var_512[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_512.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
