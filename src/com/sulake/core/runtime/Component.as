package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_870:uint = 4;
      ...
      protected var var_367:uint = 0;
      
      protected var var_29:IContext = null;
      
      protected var var_2062:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_898 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_898);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1063 & const_870)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_367 + "]";
      }
   }
}
