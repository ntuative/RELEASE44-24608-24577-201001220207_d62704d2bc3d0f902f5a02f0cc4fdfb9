package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_774:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_332)
         {
            ...
            if(var_332)
            {
               var_332.addEventListener(WindowEvent.const_225,scrollBarEventProc);
               var_332.addEventListener(WindowEvent.const_196,scrollBarEventProc);
            }
         }
         return var_332;
      }
      ...
      override public function dispose() : void
      {
         if(var_332)
         {
            var_332.removeEventListener(WindowEvent.const_225,scrollBarEventProc);
            var_332.removeEventListener(WindowEvent.const_196,scrollBarEventProc);
            var_332 = null;
         }
         if(var_774)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_774)
         {
            var_774 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_774;
      }
