package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1009:String = "tool_tip_caption";
      
      protected static const const_1373:uint = 500;
      ...
      protected var var_2227:uint = 0;
      
      protected var var_893:String = "";
      
      protected var var_426:Array;
      
      protected var var_892:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_426 = new Array();
         var_426[0] = MouseCursorType.const_305;
         var_426[1] = MouseCursorType.const_37;
         var_426[2] = MouseCursorType.const_305;
         var_426[3] = MouseCursorType.const_305;
         var_426[4] = MouseCursorType.const_37;
         var_426[5] = MouseCursorType.const_37;
         var_426[6] = MouseCursorType.const_305;
         if(var_320 == null)
         {
            var_320 = new Array();
      ...
      {
         param2.push(new PropertyStruct(const_1009,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_730));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_994,param1.toolTipDelay != const_1373));
         return param2;
      }
      ...
      {
         var_893 = param1 == null ? const_730 : param1;
      }
