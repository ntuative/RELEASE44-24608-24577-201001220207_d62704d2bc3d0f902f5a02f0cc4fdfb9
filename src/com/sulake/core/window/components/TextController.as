package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2295:Rectangle = new Rectangle();
      ...
      protected var var_511:String = "none";
      
      protected var var_596:Number;
      ...
      {
         return new Rectangle(var_596 * maxScrollH,var_359 * maxScrollV,width,height);
      }
      ...
      {
         var_596 = param1;
         _field.scrollH = var_596 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_994,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_58,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_572,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_572,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_75.left,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("margin_top",var_75.top,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("margin_right",var_75.right,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_75.bottom,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("auto_size",var_511,PropertyStruct.STRING,var_511 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_572,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_511 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_511 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_511 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_511 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
