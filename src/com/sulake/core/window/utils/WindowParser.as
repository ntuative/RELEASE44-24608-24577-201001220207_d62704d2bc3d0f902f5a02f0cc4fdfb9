package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_823:String = "_EXCLUDE";
      
      public static const const_1454:String = "_TEMP";
      ...
      protected var var_888:Dictionary;
      
      protected var var_1319:Map;
      
      protected var var_29:IWindowContext;
      
      protected var var_1318:Dictionary;
      
      protected var var_1058:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1058,var_1059);
         var_888 = new Dictionary();
         var_1318 = new Dictionary();
         ParamCodeTable.fillTables(var_888,var_1318);
         var_1319 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1058)
            {
               delete var_1058[_loc1_];
            }
            for(_loc1_ in var_1059)
            {
               delete var_1059[_loc1_];
            }
            for(_loc1_ in var_888)
            {
               delete var_888[_loc1_];
            }
            for(_loc1_ in var_1318)
            {
               delete var_1318[_loc1_];
            }
            var_1319.dispose();
            var_1319 = null;
            var_29 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_823) == -1)
                  {
