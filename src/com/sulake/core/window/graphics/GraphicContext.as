package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1547:uint = 128;
      
      public static const const_1486:uint = 64;
      ...
      protected var var_1552:Boolean;
         ...
         if(var_599)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1552,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1552,16777215);
                  }
                  var_365 += bitmap.width * bitmap.height * 4;
               }
      ...
      public function method_14(param1:IGraphicContext) : int
      {
