package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private var var_2050:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2050 = new Dictionary();
         TypeCodeTable.fillTables(var_1492,var_2050);
         var_1246 = new Dictionary();
         var_2051 = new Dictionary();
         StateCodeTable.fillTables(var_1246,var_2051);
         ...
         var_492["HabboWindowManagerCom_habbo_skin_border_slot_xml"] = NullSkinRenderer;
         if(var_366 == null)
         {
            var_366 = new Array();
            var_366.push(WindowState.const_61);
            var_366.push(WindowState.const_67);
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1492[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_570[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_570[param1] = new Array(SkinContainer.const_1095);
         }
         var_570[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_570[_loc1_]).dispose();
